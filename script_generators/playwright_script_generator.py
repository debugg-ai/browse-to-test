...
class PlaywrightScriptGenerator:
    ...
    def __init__(
        ...
        context_config: BrowserProfile | None = None,
    ):
        """
    ...
    def _generate_context_options(self) -> str:
        """Generates the options string for context creation based on BrowserProfile."""
        if not self.context_config:
            return ""  # Default context

        options_dict = {}

        # Map relevant BrowserProfile fields to Playwright context options
